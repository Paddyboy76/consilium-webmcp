...
| Enso / workflow waits | `frontend/src/components/ui/EnsoLoader.jsx` | Exact circular path, `rotate(-90 50 50)`, red paint stroke, two-second draw, orange mono stage identity; reduced-motion freezes the completed stroke | Client-known stages track validation/retrieval/analysis/hydration/persistence; council names come from actual appointments. |
